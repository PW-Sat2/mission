tasks = [
    ...
    [tc.DownloadFile(50, '/radfet_8', range(0, 8)), Send, WaitMode.Wait],
    [tc.DownloadFile(51, '/radfet_8', range(8, 16)), Send, WaitMode.Wait],
    [tc.DownloadFile(52, '/radfet_8', range(16, 24)), Send, WaitMode.Wait],
