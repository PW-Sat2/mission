tasks = [
    ...
    [tc.SendBeacon(), Send, WaitMode.NoWait],
    [tc.DownloadFile(45, '/telemetry.current', [i for i in range(6, 1200, 100)]), Send, WaitMode.Wait],
    [tc.SendBeacon(), Send, WaitMode.NoWait],
    [tc.DownloadFile(46, '/telemetry.current', [i for i in range(18, 1200, 100)]), Send, WaitMode.Wait],
    [tc.SendBeacon(), Send, WaitMode.NoWait],
    [tc.DownloadFile(47, '/telemetry.current', [i for i in range(31, 1200, 100)]), Send, WaitMode.Wait],
    [tc.SendBeacon(), Send, WaitMode.NoWait],
    [tc.DownloadFile(48, '/telemetry.current', [i for i in range(43, 1200, 100)]), Send, WaitMode.Wait],
    [tc.SendBeacon(), Send, WaitMode.NoWait],
    [tc.DownloadFile(45, '/telemetry.current', [i for i in range(56, 1200, 100)]), Send, WaitMode.Wait],
    [tc.SendBeacon(), Send, WaitMode.NoWait],
    [tc.DownloadFile(46, '/telemetry.current', [i for i in range(68, 1200, 100)]), Send, WaitMode.Wait],
    [tc.SendBeacon(), Send, WaitMode.NoWait],
    [tc.DownloadFile(47, '/telemetry.current', [i for i in range(81, 1200, 100)]), Send, WaitMode.Wait],
    [tc.SendBeacon(), Send, WaitMode.NoWait],
    [tc.DownloadFile(48, '/telemetry.current', [i for i in range(93, 1200, 100)]), Send, WaitMode.Wait],
