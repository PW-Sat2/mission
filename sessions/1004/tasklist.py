tasks = [
    # Generated on 2019-05-05 09:58:15.211347, contains telemetry from sessions 1002 to 1004.
    # The session starts on 2019-05-05 11:17:41+02:00.
    ...
    [tc.DownloadFile(31, '/telemetry.current', [7, 57, 107, 157, 207, 257, 307, 357, 407, 32, 82, 132, 182, 232, 282, 332, 382, 20, 70, 120]), Send, WaitMode.Wait],
    ...
    [tc.DownloadFile(34, '/telemetry.current', [170, 220, 270, 320, 370, 44, 94, 144, 194, 244, 294, 344, 394, 14, 64, 114, 164, 214, 264, 314]), Send, WaitMode.Wait],
    [tc.DownloadFile(35, '/telemetry.previous', [1724, 1774, 1824, 1874, 1924, 1974, 2024, 2074, 2124, 2174, 2224, 2274, 1394, 1444, 1494, 1544, 1594, 1644, 1694, 1744]), Send, WaitMode.Wait],
    [tc.DownloadFile(36, '/telemetry.previous', [1794, 1844, 1894, 1944, 1994, 2044, 2094, 2144, 2194, 2244, 1406, 1456, 1506, 1556, 1606, 1656, 1706, 1756, 1806, 1856]), Send, WaitMode.Wait],
    [tc.DownloadFile(37, '/telemetry.current', [364, 414, 26, 76, 126, 176, 226, 276, 326, 376, 38, 88, 138, 188, 238, 288, 338, 388, 0, 50]), Send, WaitMode.Wait],
    [tc.DownloadFile(38, '/telemetry.previous', [1906, 1956, 2006, 2056, 2106, 2156, 2206, 2256, 1418, 1468, 1518, 1568, 1618, 1668, 1718, 1768, 1818, 1868, 1918, 1968]), Send, WaitMode.Wait],
    [tc.DownloadFile(39, '/telemetry.previous', [2018, 2068, 2118, 2168, 2218, 2268, 1430, 1480, 1530, 1580, 1630, 1680, 1730, 1780, 1830, 1880, 1930, 1980, 2030, 2080]), Send, WaitMode.Wait],
    [tc.DownloadFile(40, '/telemetry.previous', [2130, 2180, 2230]), Send, WaitMode.Wait],
    [tc.DownloadFile(41, '/telemetry.current', [100, 150, 200, 250, 300, 350, 400]), Send, WaitMode.Wait],
    # auto-generated telemetry end


    # missing from previous session start
    [tc.DownloadFile(42, '/telemetry.previous', [1233, 1283, 1333, 1383]), Send, WaitMode.Wait],
