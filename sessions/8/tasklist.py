tasks = [
    ...
    [tc.SendBeacon(), Send, WaitMode.NoWait],
    [tc.DownloadFile(55, '/telemetry.current', [i for i in range(1, 200, 10)]), Send, WaitMode.Wait],
    [tc.SendBeacon(), Send, WaitMode.NoWait],
    [tc.DownloadFile(61, '/telemetry.current', [i for i in range(3, 200, 10)]), Send, WaitMode.Wait],
    [tc.SendBeacon(), Send, WaitMode.NoWait],
    [tc.DownloadFile(57, '/telemetry.current', [i for i in range(4, 200, 10)]), Send, WaitMode.Wait],
    [tc.SendBeacon(), Send, WaitMode.NoWait],
    [tc.DownloadFile(58, '/telemetry.current', [i for i in range(6, 200, 10)]), Send, WaitMode.Wait],
    [tc.SendBeacon(), Send, WaitMode.NoWait],
    [tc.DownloadFile(59, '/telemetry.current', [i for i in range(8, 200, 10)]), Send, WaitMode.Wait],
    [tc.SendBeacon(), Send, WaitMode.NoWait],
    [tc.DownloadFile(60, '/telemetry.current', [i for i in range(9, 200, 10)]), Send, WaitMode.Wait],
]
