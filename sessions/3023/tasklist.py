tasks = [
    ...
    [tc.TakePhotoTelecommand(10, CameraLocation.Wing, PhotoResolution.p128, 1, datetime.timedelta(minutes=20), 'p1_128'), Send, WaitMode.Wait],
    ...
    # =========================================
    [tc.PerformRadFETExperiment(10, 150, 110, 'radfet_34'), Send, WaitMode.Wait],
