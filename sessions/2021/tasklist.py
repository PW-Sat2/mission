tasks = [
    # Generated on 2019-10-13 00:04:49.308000, contains telemetry from sessions 2019 to 2021.
    ...
    [tc.DownloadFile(95, '/telemetry.current', [548, 598, 648, 698, 748, 798, 848, 898, 948, 998, 1048, 1098, 1148, 1198, 1248, 1298, 1348, 1398, 1448, 1498]), Send, WaitMode.Wait],
    [tc.DownloadFile(96, '/telemetry.current', [1548, 1598, 1648, 1698, 1748, 1798, 1848, 573, 623, 673, 723, 773, 823, 873, 923, 973, 1023, 1073, 1123, 1173]), Send, WaitMode.Wait],
    [tc.DownloadFile(97, '/telemetry.current', [1223, 1273, 1323, 1373, 1423, 1473, 1523, 1573, 1623, 1673, 1723, 1773, 1823, 561, 611, 661, 711, 761, 811, 861]), Send, WaitMode.Wait],
    [tc.DownloadFile(98, '/telemetry.current', [911, 961, 1011, 1061, 1111, 1161, 1211, 1261, 1311, 1361, 1411, 1461, 1511, 1561, 1611, 1661, 1711, 1761, 1811, 585]), Send, WaitMode.Wait],
    [tc.DownloadFile(99, '/telemetry.current', [635, 685, 735, 785, 835, 885, 935, 985, 1035, 1085, 1135, 1185, 1235, 1285, 1335, 1385, 1435, 1485, 1535, 1585]), Send, WaitMode.Wait],
    [tc.DownloadFile(100, '/telemetry.current', [1635, 1685, 1735, 1785, 1835, 555, 605, 655, 705, 755, 805, 855, 905, 955, 1005, 1055, 1105, 1155, 1205, 1255]), Send, WaitMode.Wait],
    [tc.DownloadFile(101, '/telemetry.current', [1305, 1355, 1405, 1455, 1505, 1555, 1605, 1655, 1705, 1755, 1805, 1855, 567, 617, 667, 717, 767, 817, 867, 917]), Send, WaitMode.Wait],
    [tc.DownloadFile(102, '/telemetry.current', [967, 1017, 1067, 1117, 1167, 1217, 1267, 1317, 1367, 1417, 1467, 1517, 1567, 1617, 1667, 1717, 1767, 1817, 579, 629]), Send, WaitMode.Wait],
    [tc.DownloadFile(103, '/telemetry.current', [679, 729, 779, 829, 879, 929, 979, 1029, 1079, 1129, 1179, 1229, 1279, 1329, 1379, 1429, 1479, 1529, 1579, 1629]), Send, WaitMode.Wait],
    [tc.DownloadFile(104, '/telemetry.current', [1679, 1729, 1779, 1829, 591, 641, 691, 741, 791, 841, 891, 941, 991, 1041, 1091, 1141, 1191, 1241, 1291, 1341]), Send, WaitMode.Wait],
    [tc.DownloadFile(105, '/telemetry.current', [1391, 1441, 1491, 1541, 1591, 1641, 1691, 1741, 1791, 1841]), Send, WaitMode.Wait],
