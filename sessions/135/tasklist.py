tasks = [
    ...
    ["Becon send loop - next is previously not downloaded telemetry.previous", Print, WaitMode.NoWait],
    [[tc.SendBeacon(), 5], SendLoop, WaitMode.NoWait],

    # ================================================================================
    # WE ARE GOING TO SAVE THE ENERY - DOWNLOADING TELEMETRY BELOW IS NOT RECOMMENDED!
    # ================================================================================
