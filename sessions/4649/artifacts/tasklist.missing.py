tasks = [
[tc.DownloadFile(30, '/telemetry.current', [253, 290, 333, 347, 1180]), Send, WaitMode.Wait],
	[tc.DownloadFile(31, '/telemetry.previous', [1370, 1513, 1563, 1613, 1620, 1663, 1683, 1751, 1763, 1913, 1963, 2251]), Send, WaitMode.Wait],
