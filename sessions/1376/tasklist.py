tasks = [
    ...
    [tc.DownloadFile(154, '/p8_240_0', [72, 73, 74, 75, 76, 77]), Send, WaitMode.Wait],
    ...
    [tc.DownloadFile(164, '/p9_240_0', [72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89]), Send, WaitMode.Wait],
    [tc.DownloadFile(165, '/p9_240_0', [90, 91, 92, 93, 94, 95, 96, 97, 98]), Send, WaitMode.Wait],
    ...
    [tc.DownloadFile(183, '/p10_240_0', [i for i in range(60, 74, 1)]), Send, WaitMode.Wait],
