tasks = [
[tc.DownloadFile(30, '/telemetry.current', [263, 300, 313, 320, 413, 420, 463]), Send, WaitMode.Wait],
	[tc.DownloadFile(31, '/telemetry.previous', [1426, 1458, 1476, 1488, 1508, 1514, 1526, 1571, 1928, 2028]), Send, WaitMode.Wait],
